// <?php
// 	// Your Email
// 	$recipient = "marianna.tsapiv@gmail.com"; // PLEASE SET THE EMAIL ADDRESS of recipient
// 	$recipient_name = "Mariana"; // PLEASE SET THE NAME OF the email address holder
// 	$subject_title = "vitaliihorban93@gmail.com"; //
//
// 	// Check $recipient
// 	if($recipient === '') {
